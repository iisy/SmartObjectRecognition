...
/**
 * Simple Activity based on OpenCV-Sample
 * @author Ismail Yildiz
 *
 */

public class SmartObjectRecognitionActivity extends Activity implements OnTouchListener, CvCameraViewListener2 {
	
	private static final String    TAG = "SmartObjectRecognitionActivity";
	...
	/*
	 * Mat die für die Objekterkennung genutzt werden. Sie sind in RGB und Grauwert vorhanden.
	...
	private Rect touchedRect;			// Auswahlrecteck mittels Berühren auf dem Bildschirm
	private Point touchPoint;			// Berührpunkt auf dem Bildschirm
	
	private boolean  mIsObjectSelected = false;	// Wenn auf das Bildschirm getippt wird, wird der darunter liegende Bild im Rechteck als Objekt ausgewählt. Is ein Objektbild ausgewählt?
	private boolean mDrawSelectedRect = false;	// soll der Ausgewählte Rechteck kurz in einem Frame erscheinen
