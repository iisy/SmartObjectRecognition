...
JNIEXPORT void JNICALL Java_com_isy_smartobjectrecognition_SmartObjectRecognitionActivity_FindObject(JNIEnv* env, jobject, jlong addrGray, jlong addrRgba, jlong addrObjGray, jstring detectorName,  jstring descriptorName, jstring matcherName);

JNIEXPORT void JNICALL Java_com_isy_smartobjectrecognition_SmartObjectRecognitionActivity_FindFeatures(JNIEnv* env, jobject, jlong addrGray, jlong addrRgba, jstring detectorName);
...
JNIEXPORT void JNICALL Java_com_isy_smartobjectrecognition_SmartObjectRecognitionActivity_FindObject(JNIEnv* env, jobject, jlong addrGray, jlong addrRgba, jlong addrObjGray, jstring detectorName,  jstring descriptorName, jstring matcherName){
    ...
    */
	...
	//const char* detector_name = "ORB";
    //const char* descriptor_name = "ORB";
    //const char* matcher_name = "BruteForce-Hamming";
